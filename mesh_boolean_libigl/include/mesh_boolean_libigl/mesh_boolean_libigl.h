...
namespace mesh_boolean_libigl{
  ...
  // Out = [v1 v2 v3 v4 ..]
  // Out = [f1 f2 f3 f4 ..]
  bool boolean_intersection(const Eigen::MatrixXd& InV1, const Eigen::MatrixXi& InF1, const Eigen::MatrixXd& InV2, const Eigen::MatrixXi& InF2, Eigen::MatrixXd& OutV, Eigen::MatrixXi& OutF, bool verbose=false);
